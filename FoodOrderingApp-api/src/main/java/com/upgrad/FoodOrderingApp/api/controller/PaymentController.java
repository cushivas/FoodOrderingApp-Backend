...
public class PaymentController {
	...
	/*
	 * The method handles get all payment methods fro the order. & produces response
	 * in PaymentListResponse and returns details of all the payment methods UUID
	 * and Name and if error returns error code and error Message.
	 */
	@CrossOrigin
	@RequestMapping(method = RequestMethod.GET, path = "", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public ResponseEntity<PaymentListResponse> getAllPaymentMethods() {

		// Calls getAllPaymentMethods of paymentService tp get all the paymentEntity in
		// DB
