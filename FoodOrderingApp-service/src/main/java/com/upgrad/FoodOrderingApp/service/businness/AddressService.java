...
public class AddressService {
    ...
    public AddressEntity saveAddress(final AddressEntity addressEntity, final CustomerEntity customerEntity) throws SaveAddressException {
        if (addressEntity.getActive() != null && addressEntity.getLocality() != null && !addressEntity.getLocality().isEmpty()
     ...
     * @throws AddressNotFoundException if the address entered is not exist in database
     */
    ...
    public AddressEntity getAddressByUUID(final String addressId, final CustomerEntity customerEntity) throws AuthorizationFailedException, AddressNotFoundException {
        ...
        CustomerAddressEntity customerAddressEntity = customerAddressDao.getCustomerAddressByAddressId(addressEntity);
     ...
     * @throws AddressNotFoundException if the state with entered  id is not found in database
     */
