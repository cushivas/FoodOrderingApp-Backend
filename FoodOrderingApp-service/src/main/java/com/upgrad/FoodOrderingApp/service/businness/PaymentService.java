...
public class PaymentService {
	...
	/*
	 * This method is to get Payment By UUID.Takes the paymentId and returns the
	 * PaymentEntity. If error throws exception with error code and error message.
	 */
	...
	/*
	 * This method is to get All Payment Methods.Takes the couponName and returns
	 * the PaymentEntity. If error throws exception with error code and error
	 * message.
	 */
